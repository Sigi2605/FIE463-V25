...
def compute_labor_ex_demand(w, par: Parameters):
    ...
    #Solve HH problem for type 1 
    c1_opt, h1_opt = solve_hh(w, pi=0.0, par=par)

    #Solve HH problem for type 2 
    #Profits given for each type 2 HH 
    pi2 = Pi / par.N2
    c2_opt, h2_opt = solve_hh(w, pi2, par)    

    # Aggregate excess demand for labor
    ex_demand = L - par.N1 * h1_opt - par.N2 * h2_opt
